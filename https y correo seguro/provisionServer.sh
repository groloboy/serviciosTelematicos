sudo yum install -y mod_ssl dovecot telnet telnet-server sendmail sendmail-cf net-tools httpd vim git bind-utils bind-libs bind-*
...
hostnamectl set-hostname server.servicios.com
